...
import { StorjModule } from './models/storj/storj.module';
import { BucketVersioningModule } from './models/bucket-versioning/bucket-versioning.module';
@Module({
  imports: [
